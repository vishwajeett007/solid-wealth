...
function buildModuleSpecificExplanation(
...
const categoryLessons: Record<
  CourseModule["category"],
  { why: string; caution: string; action: string }
> = {
  Theory: {
  ...
  "Taxation & Compliance": {
    ...
    caution:
      "Tax and regulatory treatment can change and may depend on dates, residency, scheme classification, and personal facts. Verify current official rules before acting.",
    action:
      "Record the applicable date, investor status, scheme classification, and official source used for the conclusion.",
  },
...
export function getCourseTopicLesson(
  courseModule: CourseModule,
  topic: string,
): CourseTopicLesson {
  ...
  return {
    ...
    practicalApplication:
      practicalApplications[courseModule.moduleNumber] ??

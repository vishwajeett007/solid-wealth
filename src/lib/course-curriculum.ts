...
export const professionalDeepDives: CourseDeepDive[] = [
    {
        ...
        description: "Build the quantitative foundation needed to calculate goals, cash flows, and real investor outcomes.",
        topics: [
    ...
    },
    {
        ...
        description: "Understand the underlying businesses held by a fund without turning the course into stock-picking training.",
        topics: [
    ...
    },
    {
        ...
        description: "Learn how credit quality, duration, spreads, and rate cycles change the behaviour of debt portfolios.",
        topics: [
    ...
    },
    {
        ...
        description: "Bridge the gap between choosing individual funds and building a resilient, goal-aligned portfolio.",
        topics: [
...
export function getModulesForLevel(level: CourseLevel) {
    ...
    return courseCurriculum.filter((courseModule) => courseModule.moduleNumber >= start && courseModule.moduleNumber <= end);
}
export function getCourseLevelForModule(moduleNumber: number) {
    return courseLevels.find((level) => moduleNumber >= level.moduleRange[0] &&

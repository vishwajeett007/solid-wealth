...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-wealth-primary text-white shadow-[0_4px_16px_rgba(12,31,26,0.18)] hover:bg-wealth-accent hover:shadow-[0_8px_24px_rgba(28,184,126,0.30)]",
  ghost:
    "border border-wealth-border bg-transparent text-wealth-primary hover:border-wealth-accent hover:text-wealth-accent",
  accent:
    "bg-wealth-accent text-white shadow-[0_8px_30px_rgba(28,184,126,0.35)] hover:bg-[#15A570] hover:shadow-[0_12px_40px_rgba(28,184,126,0.45)]",
  white:

...
export function AnalyticsSection() {
  return (
    <SectionWrapper className="py-16 sm:py-20" id="analytics" width="wide">
      <div className="relative grid overflow-hidden rounded-wealth-xl border border-wealth-dark-border bg-[radial-gradient(circle_at_top_right,rgba(28,184,126,0.16)_0%,rgba(28,184,126,0)_42%),#0A1612] p-7 sm:p-10 lg:grid-cols-2 lg:gap-16 lg:p-16">
        <div className="relative z-10">
          <SectionLabel icon={sectionIcons.trending} tone="dark">
            80% Performance Increase
          </SectionLabel>
          <h2 className="mt-6 font-display text-3xl font-bold leading-tight tracking-normal text-[#F0FAF6] sm:text-4xl">
            Next-Gen Wealth Dashboard
          </h2>
          <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-[#6B9B8F]">
        ...
        <div className="relative z-10 mt-10 rounded-wealth-lg border border-wealth-dark-border bg-white/[0.03] p-5 sm:p-7 lg:mt-0">
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex gap-3">
              <LegendItem color="green" label="Equity" />
              ...
              <defs>
                ...
                >
                  <stop
                    ...
                    stopOpacity="0.25"
                  />
                  <stop offset="100%" stopColor="#4DD4A0" stopOpacity="0" />
                </linearGradient>
              </defs>
              <path
...
function LegendItem({ color, label }: LegendItemProps) {
  return (
    <span className="inline-flex items-center gap-1.5 font-mono text-[11px] text-[#6B9B8F]">
      <span
        className={
          color === "green"
            ? "size-2 rounded-full bg-wealth-accent-mid"

...
export function CTASection() {
  return (
    <section className="px-5 pb-16 sm:px-8 sm:pb-20 lg:px-20">
      <div className="mx-auto flex max-w-[1440px] flex-col gap-8 overflow-hidden rounded-wealth-xl bg-[linear-gradient(135deg,var(--wealth-text-primary)_0%,#0f1e36_100%)] p-8 shadow-wealth-lg sm:p-12 lg:flex-row lg:items-center lg:justify-between lg:p-20">
        <div>

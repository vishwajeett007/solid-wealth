...
export function CTASection() {
  return (
    <section className="px-5 pb-16 sm:px-8 sm:pb-20 lg:px-20">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 overflow-hidden rounded-wealth-xl bg-[linear-gradient(135deg,var(--wealth-text-primary)_0%,#1A3530_100%)] p-8 shadow-wealth-lg sm:p-12 lg:flex-row lg:items-center lg:justify-between lg:p-20">
        <div>

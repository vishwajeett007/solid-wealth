    ...
    return (<section id="download-app" className="relative w-full bg-[#FFFDF4] pt-16 overflow-hidden mb-8">
      ...
      <div className="max-w-[1440px] mx-auto relative z-10 flex flex-col items-center">
        ...
        <div className="relative w-full max-w-[1200px] h-[400px] md:h-[550px] flex justify-center mt-6">
          ...
          <div className="relative w-[320px] md:w-[450px] z-10 h-full">
            <Image src="/footerphone.png" alt="Solid Wealth Phone Mockup" fill sizes="(max-width: 768px) 320px, 450px" className="object-contain object-top drop-shadow-2xl" priority/>
          </div>
        </div>
      </div>
      ...
      <div className="w-full overflow-hidden whitespace-nowrap mt-[-80px] relative z-20 pointer-events-none bg-white/70 py-1">
        ...
        <div className="animate-ticker inline-flex items-center">
          {[1, 2, 3].map((i) => (<span key={i} className="text-[35px] md:text-[60px] lg:text-[65px] font-black text-[#fe9800]/40 mx-4 tracking-wider uppercase" style={{ fontFamily: 'var(--font-sora)' }}>
